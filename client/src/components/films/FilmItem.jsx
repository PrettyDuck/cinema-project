  ...
  return (
    <div className='max-w-sm rounded overflow-hidden shadow-lg'>
      ...
      <div className='px-6 py-2'>
        <div className='font-bold text-xl'>{film.name}</div>
      ...
      <div className='px-6 pb-4'>
        {film.category.map((element) => (
          <span key={element.id} className='inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2'>
